...
<header className="sticky top-0 w-full z-30 bg-[#EDEDED] border-b border-[#E5E5E5] flex items-center justify-between px-4 pb-2 pt-[max(env(safe-area-inset-top,20px),20px)]" data-ui="header">
